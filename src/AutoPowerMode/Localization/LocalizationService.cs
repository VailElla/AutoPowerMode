...
public static class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["ActiveCheckInterval"] = "Active check interval",
        ...
        ["CheckIntervalRangeValidation"] = "Check intervals must be between {0} and {1} seconds.",
    ...
    private static readonly IReadOnlyDictionary<string, string> SimplifiedChinese = new Dictionary<string, string>
    {
        ...
        ["MonitoringScheduleValue"] = "活跃：每 {0} 秒；空闲：每 {1} 秒",
        ["ActiveCheckInterval"] = "活跃检测频率",
        ["IdleCheckInterval"] = "空闲时检测频率",
        ...
        ["CheckIntervalRangeValidation"] = "活跃和空闲检测频率必须在 {0} 到 {1} 秒之间。",
