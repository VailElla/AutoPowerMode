...
public static class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["CheckRangeValidation"] = "Check interval must be between {0} and {1} seconds.",
        ...
        ["CheckIntervalValue"] = "Check interval: {0}",
        ...
        ["CheckIntervalMenu"] = "Check interval: {0} seconds",
    ...
    private static readonly IReadOnlyDictionary<string, string> SimplifiedChinese = new Dictionary<string, string>
    {
        ...
        ["CheckRangeValidation"] = "检测间隔必须在 {0} 到 {1} 秒之间。",
